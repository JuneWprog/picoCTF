...
In the last few rows, I saw `{ 3 n h 4 n ` and `c 3 d _ 2 4 3 7 4 6 7 5 }`, which looked like the flag, so I concatenated this to form `{3nh4nc3d_6783cc46}`. I assumed that this was the flag, and I just needed to add the `picoCTF` wrapper.
